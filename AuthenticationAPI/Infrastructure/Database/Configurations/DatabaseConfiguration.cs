...
namespace AuthenticationAPI.Infrastructure.Database.Configurations
{
    /// <summary>
    /// Provides a set of utilities and global configurations for database schema conventions, including entity and property naming, foreign key
    /// constraint naming, index naming, and GUID primary key column configuration.
    /// </summary>
    public static class DatabaseConfiguration
    {
        ...
        /// <summary>
        /// Applies global naming and type conventions to all entities in the model builder, including table names, column names, foreign key constraint
        /// names, index names, and GUID primary key columns.
        /// </summary>
        /// <remarks>
        /// This method standardizes entity and property naming to snake_case and configures GUID primary keys to use the 'uuid' column type with value
        /// generation on adding.
