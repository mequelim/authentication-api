...
using AuthenticationAPI.Shared.Extensions;
...
namespace AuthenticationAPI
{
    public static class DependencyInjection
    {
        ...
        {
            /// <summary>
            /// Adds API-specific services to the application's dependency injection container.
            /// </summary>
            /// <remarks>
            /// This method registers the core services required by the API, such as scoped services, API controllers, and OpenAPI documentation configurations.
            /// It configures the dependency injection for the `IAuthService` implementation and sets up support for controllers and endpoint exploration.
            /// Additionally, it customizes the OpenAPI generation to include security schemes and requirements for JWT Bearer authentication.
            /// </remarks>
            ...
            /// <summary>
            /// Configures the application's database services, including the setup of the Entity Framework database context and connection string for PostgreSQL.
            /// </summary>
            /// <remarks>
